    ...
    <div>
      ...
      >
        ...
        <div className='flex gap-3 items-center py-3 flex flex-col md:flex-row '>
          ...
          <div className='border-2 border-gray-800 w-0 h-7'></div>
          <h1 className='text-2xl bg-gradient-to-r from-blue-500 to-blue-900 bg-clip-text text-transparent'> AI </h1>
        </div>
        ...
        <motion.div className='flex gap-5 items-center justify-center flex-col md:flex-row ' 
        initial={{ opacity: 0 , y : -50}}
      animate={{ opacity : 1 , y : 0}}
      transition={{ duration: 0.5}}>
          <button className='bg-white border flex mt-8 px-3 py-2 border border-blue-900 rounded-lg 
