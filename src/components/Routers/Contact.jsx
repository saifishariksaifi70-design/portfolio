...
import { FaCircle, FaComment, FaMousePointer, FaRegComments, FaCommentDots, FaTelegramPlane, 
  FaVoicemail, FaPhone, FaLocationArrow, FaLinkedin, FaGithub, FaHandshake, FaArrowRight } from 'react-icons/fa'
  import AOS from 'aos'
...
const Contact = () => {
  ...
  return (
    <div className='bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white' data-aos="zoom-in-right">
